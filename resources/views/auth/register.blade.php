    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
         ...
         <div class="mt-4">
            ...
            <select  name="rol" id="rol" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-300 shadow-sm focus:ring-gray-300 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-800 w-full">
